...
/* harmony import */ var _Utils_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Utils.js */ "./src/js/services/Utils.js");
...
var handleOnLoad = function handleOnLoad() {
  ...
  mainWrapper.innerHTML = page.render(); // mainWrapper.innerHTML += Bottombar.render();
};
...
/* harmony export */ });
/* harmony import */ var _imagesRu_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../imagesRu.json */ "./src/js/imagesRu.json");
/* harmony import */ var _views_components_Result_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../views/components/Result.js */ "./src/js/views/components/Result.js");
...
var artistsQuestions = [];
var pictureQuestions = [];

for (var i = 0; i < _imagesRu_json__WEBPACK_IMPORTED_MODULE_0__.length; i++) {
  i < _imagesRu_json__WEBPACK_IMPORTED_MODULE_0__.length / 2 ? artistsQuestions.push(_imagesRu_json__WEBPACK_IMPORTED_MODULE_0__[i]) : pictureQuestions.push(_imagesRu_json__WEBPACK_IMPORTED_MODULE_0__[i]);
  questions.artists = artistsQuestions;
  questions.pictures = pictureQuestions;
}

var results = [new _views_components_Result_js__WEBPACK_IMPORTED_MODULE_1__.Result('Живопись - не Ваша сильная сторона', 0), new _views_components_Result_js__WEBPACK_IMPORTED_MODULE_1__.Result('Неплохой результат, но есть, к чему стремиться', 5), new _views_components_Result_js__WEBPACK_IMPORTED_MODULE_1__.Result('Вы эксперт в области живописи', 10)];
...
/***/ "./src/js/views/components/Answer.js":
/*!*******************************************!*\
  !*** ./src/js/views/components/Answer.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _services_Utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/Utils.js */ "./src/js/services/Utils.js");
/* harmony import */ var _imagesRu_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../imagesRu.json */ "./src/js/imagesRu.json");
...
var Answer = /*#__PURE__*/function () {
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Answer, [{
    ...
    value: function generateAnswers(data) {
      ...
      for (var i = 0; i < 3; i++) {
        var randomNumber = (0,_services_Utils_js__WEBPACK_IMPORTED_MODULE_2__.getRandomNum)(0, 240);
      ...
      var variants = []; //массив с вариантами авторов
      ...
      for (var _i = 0; _i < 4; _i++) {
        ...
        answer.innerHTML = "".concat(variants[_i]);
...
/***/ "./src/js/views/components/Article.js":
/*!********************************************!*\
  !*** ./src/js/views/components/Article.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Article = /*#__PURE__*/function () {
  function Article(type, categoryName, route) {
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Article, [{
    ...
    value: function generateArticle() {
      ...
      var imageIndex = this.categoryName > 1 ? (this.categoryName - 1) * 10 : 0;
      template += "<p class=\"category-name\">".concat(this.categoryName, "</p>");
      template += '<div class="category-statistics">';
      template += "<span class=\"answered\">".concat(this.answered, "</span>");
      template += '<span>/</span>';
      template += '<span class="total">10</span>';
      template += '</div>';
      template += "<img class=\"category-image ".concat(this.route, "\" src=\"https://raw.githubusercontent.com/OlgaTolpykina/image-data/master/img/").concat(imageIndex, ".jpg\" alt=\"Preview\" width=\"195\" height=\"206\" data-categoryName=\"").concat(this.categoryName, "\" data-type=\"").concat(this.type, "\">");
...
var Question = /*#__PURE__*/function () {
  function Question(imageNumber, categoryName, right, wrong) {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, Question);
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Question, [{
    ...
    value: function generateQuestion() {
      ...
      question.style.backgroundImage = "url(\"https://raw.githubusercontent.com/OlgaTolpykina/image-data/master/img/".concat(this.imageNumber, ".jpg\")");
      var list = document.createElement('ul');
      list.className = 'pagination';
      var listItems = [];

      for (var i = (this.categoryName - 1) * 10; i < (this.categoryName - 1) * 10 + 10; i++) {
        //Здесь i для первой категории - от 0 до 10, для второй - от 10 до 20 и тд
        if (this.right.includes(i)) {
          var rightAnswer = document.createElement('li');
          rightAnswer.className = 'right';
          listItems.push(rightAnswer);
        } else if (this.wrong.includes(i)) {
          var wrongAnswer = document.createElement('li');
          wrongAnswer.className = 'wrong';
          listItems.push(wrongAnswer);
        } else {
          var unanswered = document.createElement('li');
          listItems.push(unanswered);
        }
      }

      for (var _i = 0; _i < listItems.length; _i++) {
        list.insertAdjacentElement('beforeend', listItems[_i]);
      }
...
/***/ "./src/js/views/components/Quiz.js":
/*!*****************************************!*\
  !*** ./src/js/views/components/Quiz.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "quizInit": () => (/* binding */ quizInit)
/* harmony export */ });
...
/* harmony import */ var _Article_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Article.js */ "./src/js/views/components/Article.js");
/* harmony import */ var _Question_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Question.js */ "./src/js/views/components/Question.js");
/* harmony import */ var _Answer_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Answer.js */ "./src/js/views/components/Answer.js");
/* harmony import */ var _imagesRu_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../imagesRu.json */ "./src/js/imagesRu.json");
/* harmony import */ var _services_Router_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../services/Router.js */ "./src/js/services/Router.js");
/* harmony import */ var _Modal_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Modal.js */ "./src/js/views/components/Modal.js");
/* harmony import */ var _Bottombar_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Bottombar.js */ "./src/js/views/components/Bottombar.js");
/* harmony import */ var _services_Utils_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../services/Utils.js */ "./src/js/services/Utils.js");
...
var Quiz = /*#__PURE__*/function () {
  function Quiz() {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, Quiz);
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Quiz, [{
    ...
    value: function handleClickRoute(event) {
      ...
      for (var i = 0; i < _services_Router_js__WEBPACK_IMPORTED_MODULE_8__.routes.length; i++) {
        if (this.classes.includes(_services_Router_js__WEBPACK_IMPORTED_MODULE_8__.routes[i].id)) {
          window.location.href = "".concat(window.location.href.replace(/#(.*)$/, ''), "#").concat(_services_Router_js__WEBPACK_IMPORTED_MODULE_8__.routes[i].path);
          this.path = _services_Router_js__WEBPACK_IMPORTED_MODULE_8__.routes[i].path;
        }
      }
    ...
    value: function setContentToDom() {
      ...
      switch (this.path) {
        case '/categories':
          var route = "".concat(this.type, "-quiz");
    ...
    key: "getCategoriesWrapper",
    value: function getCategoriesWrapper() {
    ...
    value: function renderCategoriesToDom(route) {
      ...
      if (this.type == 'artists') {
        for (var i = 1; i <= 12; i++) {
          this.category = i;
          var article = new _Article_js__WEBPACK_IMPORTED_MODULE_4__.Article(this.type, this.category, route);
        ...
        for (var _i = 13; _i <= 24; _i++) {
          ...
          var _article = new _Article_js__WEBPACK_IMPORTED_MODULE_4__.Article(this.type, this.category, route);
    ...
    key: "renderQuestionToDom",
    value: function renderQuestionToDom() {
      this.imageNumber = this.categoryName > 1 ? (+this.categoryName - 1) * 10 + +this.current : 0 + +this.current;
      var question = new _Question_js__WEBPACK_IMPORTED_MODULE_5__.Question(this.imageNumber, this.categoryName, this.right, this.wrong);
      this.answers = new _Answer_js__WEBPACK_IMPORTED_MODULE_6__.Answer(this.imageNumber, this.categoryName);
    ...
    key: "end",
    value: function end() {//Должно вызываться модальное окно с результатом раунда
    }
  }]);
...
/***/ "./src/js/views/components/Result.js":
/*!*******************************************!*\
  !*** ./src/js/views/components/Result.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Result = /*#__PURE__*/function () {
  function Result(text, value) {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, Result);

    this.text = text;
    this.value = value;
  }

  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Result, [{
    key: "check",
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ArtistsQuizPage); // {/* <div class="content"> 
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CategoriesPage); //Сформировать data.json с данными. +
...
/* harmony import */ var _js_views_components_Quiz_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/views/components/Quiz.js */ "./src/js/views/components/Quiz.js");
/* harmony import */ var _js_views_components_Bottombar_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/views/components/Bottombar.js */ "./src/js/views/components/Bottombar.js");
...
mainWrapper.innerHTML += _js_views_components_Bottombar_js__WEBPACK_IMPORTED_MODULE_3__["default"].render();
