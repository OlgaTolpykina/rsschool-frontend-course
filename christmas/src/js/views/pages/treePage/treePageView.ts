...
class TreePageView {
  ...
  private createFavoritiesBlock(parentNode: HTMLElement, handleVariantChoice: (e: Event) => void): void {
    ...
    favoritiesWrapper.append(
      settingBlock.getTemplate('favorites_container', 'favorites', 20, 'favorites__card', undefined, favoriteCardsArray)
    );
    favoritiesWrapper.append(
      settingBlock.getTemplate('decorated_container', 'decorated', 6, 'decorated_container_inner', handleVariantChoice)
    );
